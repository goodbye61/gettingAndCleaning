...
## Description 
  ...
  On the dataset, the dimension of dataset is 180 by 81.There are 81 columns 
  in my dataset. This dataset is based on "UCI HAR Dataset". 30 subjects were
  experimented on 6 activities, and several estimates were presented. 
